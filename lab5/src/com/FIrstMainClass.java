...
class FirstMainClass extends JFrame {
    ...
    private void addLightToUniverse(){
        ...
        Vector3f lightdirection = new Vector3f(-1.f,-1.f,-1.f);
    ...
    private void addModelToUniverse() throws IOException{
        scene = getSceneFromFile("D:/Study/3 курс/2 семестр/КГ/lab5/out/LibertStatue.obj");
    ...
    private void addImageBackground(){
        TextureLoader t = new TextureLoader("D:/Study/3 курс/2 семестр/КГ/lab5/out/2-flag-usa-b.jpg", canvas);
