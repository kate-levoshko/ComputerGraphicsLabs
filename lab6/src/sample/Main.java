...
// завантаження файлу .obj.
        ...
        try
        {
            cockroachScene = f.load("D:/Study/3 курс/2 семестр/КГ/lab6/src/mike.obj");
        }
        catch (Exception e)
        {
...
//пофарбуємо тіло таргана у світло-зелений колір
        ...
        TextureLoader loader = new TextureLoader("D:/Study/3 курс/2 семестр/КГ/lab6/src/123.jpg", "LUMINACE", new Container());
